...
const jsonItemData = fs.readFileSync('./json/items.json');
const itemData = JSON.parse(jsonItemData);

const jsonEquipmentItemTypeData = fs.readFileSync('./json/equipmentItemTypes.json');
const equipmentItemTypeData = JSON.parse(jsonEquipmentItemTypeData);

const jsonItemTypeData = fs.readFileSync('./json/itemTypes.json');
const itemTypeData = JSON.parse(jsonItemTypeData);

const jsonItemPropertiesData = fs.readFileSync('./json/itemProperties.json');
...
const jsonActionsData = fs.readFileSync('./json/actions.json');
...
const writeItemDataToFile = (jsonData) => {
  let jsonFilePath = './result_data/item_data.json';
